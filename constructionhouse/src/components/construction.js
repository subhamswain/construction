...
const Construction = () => {
  ...
  <div class="container">
    <a style={{position:"relative",right:"12px"}} class="navbar-brand" href="#"><img className='logo-image' src='logo.png' style={{ width: "30px", height: "30px" }}/>ASCENDANT</a>
...
<div id="carouselExampleCaptions" class="carousel slide">
  ...
  <div class="carousel-inner h-60  m-0">
    <div class="carousel-item active h-50">
      <img style={{minHeight:"50px", backgroundSize:"cover",backgroundRepeat:"no-repeat"}}src="https://images.unsplash.com/photo-1591955506264-3f5a6834570a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fGNvbnN0cnVjdGlvbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60" class="d-block w-100" alt="..."/>
